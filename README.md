...
[![Android App](https://img.shields.io/badge/Download-Android%20APK%20-3DDC84?style=for-the-badge&logo=android&logoColor=white)](https://github.com/dimenuvel/Evangelho-das-Dimenuveis-Som/releases/tag/v1.5)
...
> 📱 **Aplicativo Android Disponível**: Baixe a versão para Android (APK v1.3) diretamente na aba de [Releases no GitHub](https://github.com/dimenuvel/Evangelho-das-Dimenuveis-Som/releases/tag/v1.5).
